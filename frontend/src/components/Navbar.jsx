...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium '>
        ...
        <Link to={'/'}><img src={assets.logo1} className='w-28 h-25' alt="" /></Link>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700 '>
            ...
            <NavLink to='/collection' className='flex flex-col items-center gap-1'>
                <p>COLLECTION</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 border-gray-300 hidden'/>
            </NavLink>
            <NavLink to='/about' className='flex flex-col items-center gap-1'>
                <p>ABOUT</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 border-gray-300 hidden'/>
            </NavLink>
            <NavLink to='/contact' className='flex flex-col items-center border-gray-300 gap-1'>
                <p>CONTACT</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-gray-700  border-gray-300 hidden'/>
            </NavLink>
